...
| `CORS_ALLOWED_ORIGINS` | `http://localhost:5173` | Recomendado | API | CORS mal configurado |
| `CSRF_TRUSTED_ORIGINS` | `http://localhost:5173` | Recomendado | API | CSRF en navegadores |
